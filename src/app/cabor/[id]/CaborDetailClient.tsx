            ...
            <div className="flex items-center gap-5 md:gap-8">
              <div className="relative">
                ...
                <div className="relative w-24 h-24 md:w-32 md:h-32 bg-white rounded-[2rem] md:rounded-[2.5rem] flex items-center justify-center p-4 md:p-6 shadow-[0_10px_40px_rgba(0,0,0,0.3)] shrink-0 border-[3px] border-white/40">
                 <img src={(cabor.image || `/cabor/${({'aeromedelling':'aeromodelling','akuatik':'renang','balap-motor':'bermotor','billiar':'biliar','biliard':'biliar','bola-basket':'basket','bola-volly':'bola-voli','bulu-tangkis':'badminton','dansa':'dansa-sport','dance-sport':'dansa-sport','drum-band':'drumband','esport':'esports','gantole':'gantolle','gimnastik':'senam','kickboxing':'kick-boxing','pencaksilat':'pencak-silat','sepak-bola':'sepakbola','softball-baseball':'softball-dan-baseball','soft-ball':'softball-dan-baseball','tinju-pertina':'tinju'} as Record<string, string>)[cabor.id as string] || cabor.id}.webp`).replace('.png', '.webp')} alt={cabor.name} className="w-full h-full object-contain drop-shadow-md" />
                </div>
              </div>
              <div>
